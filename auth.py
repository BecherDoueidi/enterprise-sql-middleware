...
def seed_default_users():
    ...
    Ships with one admin and one donor account so the app is usable
    out of the box. CHANGE THESE PASSWORDS (or delete users.db and
    create your own via create_user) before deploying anywhere real --
    shipping known default credentials is itself a vulnerability.
    """
    defaults = [
